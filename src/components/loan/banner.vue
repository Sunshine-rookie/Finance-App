  ...
  export default {
    data() {
      return {
        lists: [{
          tit: '',
          img: 'https://raw.githubusercontent.com/Sunshine-rookie/img-storage/master/flashCredit.png',
          isOn: false,
          ...
          {
            tit: '',
            img: 'https://raw.githubusercontent.com/Sunshine-rookie/img-storage/master/Auto.png',
            isOn: false,
